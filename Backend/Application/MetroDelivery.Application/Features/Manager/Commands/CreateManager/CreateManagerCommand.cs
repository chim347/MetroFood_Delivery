...
namespace MetroDelivery.Application.Features.Manager.Commands.CreateManager
{
    ...
    public class CreateManagerCommandHandler : IRequestHandler<CreateManagerCommand, string>
    {
        ...
        public CreateManagerCommandHandler(IMetroPickUpDbContext metroPickUpDbContext,
        ...
        public async Task<string> Handle(CreateManagerCommand request, CancellationToken cancellationToken)
        {
            // check email
